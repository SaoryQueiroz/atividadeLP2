...
public class DAO {
    ...
    public String exibirAluno(Aluno aluno) throws SQLException{    	
    		String sql = 
    ...
    public String exibirProfessor(Professor professor) throws SQLException {
                String sql = 
    ...
    public String exibirTodosAluno() throws SQLException {    					    		
    ...
    public String exibirTodosProfessores() throws SQLException {
